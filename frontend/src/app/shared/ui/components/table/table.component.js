...
export class UiTableComponent {constructor() { UiTableComponent.prototype.__init.call(this);UiTableComponent.prototype.__init2.call(this); }
  Input() __init() {this.columns = []}
  Input() __init2() {this.rows = []}
}

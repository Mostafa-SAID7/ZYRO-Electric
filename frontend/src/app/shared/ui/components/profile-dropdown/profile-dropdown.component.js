...
export class ProfileDropdownComponent {constructor() { ProfileDropdownComponent.prototype.__init.call(this);ProfileDropdownComponent.prototype.__init2.call(this);ProfileDropdownComponent.prototype.__init3.call(this);ProfileDropdownComponent.prototype.__init4.call(this);ProfileDropdownComponent.prototype.__init5.call(this);ProfileDropdownComponent.prototype.__init6.call(this); }
  Input() __init() {this.userName = ''}
  Input() __init2() {this.userEmail = ''}
  Input() __init3() {this.isOnline = false}
  Output() __init4() {this.logout = new EventEmitter()}

  __init5() {this.isOpen = false}
   __init6() {this.elementRef = inject(ElementRef)}

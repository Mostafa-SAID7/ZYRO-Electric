...
describe('ShippingComponent', () => {
  ...
  it('should have delivery times properly labeled', () => {
    ...
    expect(_optionalChain([standard, 'optionalAccess', _ => _.delivery])).toContain('5-10');
    expect(_optionalChain([expedited, 'optionalAccess', _2 => _2.delivery])).toContain('2-3');
    expect(_optionalChain([overnight, 'optionalAccess', _3 => _3.delivery])).toContain('Next business day');
  });
});

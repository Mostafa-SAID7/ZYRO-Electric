...
describe('HeroSliderComponent', () => {
  ...
  beforeEach(async () => {
    ...
    component.heroSlides = [
      { badge: '1', badgeIcon: '', badgeBg: '', badgeBorder: '', badgeText: '', titlePrefix: 'Slide 1', titleHighlight: '', titleSuffix: '', description: 'Sub 1', ctaPrimary: 'Go 1', ctaSecondary: '', image: 'img1.jpg', bgGradient: '', accentColor: '', tags: [] },
      { badge: '2', badgeIcon: '', badgeBg: '', badgeBorder: '', badgeText: '', titlePrefix: 'Slide 2', titleHighlight: '', titleSuffix: '', description: 'Sub 2', ctaPrimary: 'Go 2', ctaSecondary: '', image: 'img2.jpg', bgGradient: '', accentColor: '', tags: [] },
      { badge: '3', badgeIcon: '', badgeBg: '', badgeBorder: '', badgeText: '', titlePrefix: 'Slide 3', titleHighlight: '', titleSuffix: '', description: 'Sub 3', ctaPrimary: 'Go 3', ctaSecondary: '', image: 'img3.jpg', bgGradient: '', accentColor: '', tags: [] }
    ];

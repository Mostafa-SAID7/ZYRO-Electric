...
export class SessionTimeoutWarningComponent  {constructor() { SessionTimeoutWarningComponent.prototype.__init.call(this);SessionTimeoutWarningComponent.prototype.__init2.call(this);SessionTimeoutWarningComponent.prototype.__init3.call(this);SessionTimeoutWarningComponent.prototype.__init4.call(this);SessionTimeoutWarningComponent.prototype.__init5.call(this);SessionTimeoutWarningComponent.prototype.__init6.call(this);SessionTimeoutWarningComponent.prototype.__init7.call(this);SessionTimeoutWarningComponent.prototype.__init8.call(this);SessionTimeoutWarningComponent.prototype.__init9.call(this);SessionTimeoutWarningComponent.prototype.__init10.call(this);SessionTimeoutWarningComponent.prototype.__init11.call(this);SessionTimeoutWarningComponent.prototype.__init12.call(this); }
   __init() {this.sessionService = inject(SessionService)}
   __init2() {this.authService = inject(AuthService)}

   __init3() {this.destroy$ = new Subject()}

  __init4() {this.isWarningVisible = false}
  __init5() {this.isNotificationVisible = false}
  __init6() {this.isProcessing = false}
  __init7() {this.isAutoLogoutCountdown = false}

  __init8() {this.remainingTime = 0}
  __init9() {this.autoLogoutCountdown = 0}

   __init10() {this.warningThreshold = 5 * 60 * 1000} // 5 minutes
   __init11() {this.autoLogoutCountdownTime = 30 * 1000} // 30 seconds
   __init12() {this.updateInterval = null}

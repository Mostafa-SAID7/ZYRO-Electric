    ...
    <div class="p-6">
      ...
      <div *ngFor="let group of filterGroups; let last = last" 
        ...
        <div *ngIf="group.type === 'checkbox'" class="mb-6">
          ...
          <div class="space-y-3">
            <label *ngFor="let opt of group.options" class="flex items-center gap-3 cursor-pointer group">
              <!-- Custom Checkbox -->
              <div class="relative flex items-center justify-center w-5 h-5 rounded-[0.4rem] border-2 transition-all duration-200"
                ...
                <lucide-icon *ngIf="isChecked(group.id, opt.value)" name="check" class="w-3.5 h-3.5 text-accent-foreground"></lucide-icon>
              </div>
        ...
        <div *ngIf="group.type === 'rating'" class="mb-6">
          ...
          <div class="space-y-3">
            <label *ngFor="let i of [5,4,3,2,1]" class="flex items-center gap-3 cursor-pointer group">
              ...
              <div class="relative flex items-center justify-center w-5 h-5 rounded-full border-2 transition-all duration-200"
                ...
                <input
                  ...
                  class="absolute opacity-0 w-full h-full cursor-pointer m-0">
                <div *ngIf="isChecked(group.id, i)" class="w-2 h-2 rounded-full bg-accent-foreground"></div>
              </div>
        ...
        <!-- Select Filter -->
        <div *ngIf="group.type === 'select'" class="mb-6 relative">
            ...
            <div class="max-h-60 overflow-y-auto scrollbar-custom">
              <div class="p-1.5 pr-3 flex flex-col gap-0.5">
                <button 
                  ...
                  All {{ group.name }}
                  <lucide-icon *ngIf="!group.currentValue" name="check" class="w-4 h-4"></lucide-icon>
                </button>
                <button *ngFor="let opt of group.options"
                  ...
                  {{ opt.label }}
                  <lucide-icon *ngIf="group.currentValue === opt.value" name="check" class="w-4 h-4"></lucide-icon>
                </button>
              </div>
            </div>
          </div>
          ...
          <div *ngIf="isSelectOpen(group.id)" class="fixed inset-0 z-40" (click)="closeSelectDropdown(group.id)"></div>
        </div>
      </div>

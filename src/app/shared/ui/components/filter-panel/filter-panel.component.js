 function _nullishCoalesce(lhs, rhsFn) { if (lhs != null) { return lhs; } else { return rhsFn(); } } function _optionalChain(ops) { let lastAccessLHS = undefined; let value = ops[0]; let i = 1; while (i < ops.length) { const op = ops[i]; const fn = ops[i + 1]; i += 2; if ((op === 'optionalAccess' || op === 'optionalCall') && value == null) { return undefined; } if (op === 'access' || op === 'optionalAccess') { lastAccessLHS = value; value = fn(value); } else if (op === 'call' || op === 'optionalCall') { value = fn((...args) => value.call(lastAccessLHS, ...args)); lastAccessLHS = undefined; } } return value; }import { EventEmitter, } from '@angular/core';
...
export class FilterPanelComponent  {constructor() { FilterPanelComponent.prototype.__init.call(this);FilterPanelComponent.prototype.__init2.call(this);FilterPanelComponent.prototype.__init3.call(this);FilterPanelComponent.prototype.__init4.call(this);FilterPanelComponent.prototype.__init5.call(this);FilterPanelComponent.prototype.__init6.call(this); }
  Input() __init() {this.title = 'Filters'}
  Input() __init2() {this.filterGroups = []}
  Output() __init3() {this.filterChange = new EventEmitter()}
  Output() __init4() {this.panelReset = new EventEmitter()}

  __init5() {this.checkedValues = new Map()}
  __init6() {this.openDropdowns = new Set()}
  ...
  closeSelectDropdown(id) {
    this.openDropdowns.delete(id);
  }

  selectGroupOption(group, value) {
    group.currentValue = value;
    this.onFilterChange(group.id, value);
    this.closeSelectDropdown(group.id);
  }

  getSelectSelectedLabel(group) {
    if (!group.currentValue) {
      return `All ${group.name}`;
    }
    const option = _optionalChain([group, 'access', _ => _.options, 'optionalAccess', _2 => _2.find, 'call', _3 => _3(o => o.value === group.currentValue)]);
  ...
  onCheckboxChange(filterId, value, event) {
  ...
  onRatingChange(filterId, rating, event) {
    const checked = (event.target ).checked;
    if (!this.checkedValues.has(filterId)) {
      this.checkedValues.set(filterId, new Set());
    }
  ...
  isChecked(filterId, value) {
    return _nullishCoalesce(_optionalChain([this, 'access', _4 => _4.checkedValues, 'access', _5 => _5.get, 'call', _6 => _6(filterId), 'optionalAccess', _7 => _7.has, 'call', _8 => _8(value)]), () => ( false));
  }
